        ...
        {!isMobile && (
          <Grid
            ...
            sx={{
              ...
              alignItems: "center",
              background: "linear-gradient(135deg, #D3AF37 100%)",
              color: "white",
              p: 4,
              position: "relative",
              overflow: "hidden",
            ...
            <div
              style={{
                ...
                bottom: 0,
                backgroundImage:
                  'url("https://images.unsplash.com/photo-1516546453174-5e1098a4b4af?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NTN8fHRyYXZlbHxlbnwwfHwwfHx8MA%3D%3D")',
                  ...
                  <form onSubmit={handleLoginSubmit}>
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        py: 1.5,
                        fontSize: "1.1rem",
                        background: "linear-gradient(#D3AF37)",
                      }}
                      type="submit">
                      Sign In
                    </Button>
